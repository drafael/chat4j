...
- [speech-to-text.md](speech-to-text.md)
  - Speech to Text settings, Groq, ElevenLabs, Deepgram, and AssemblyAI cloud transcription, Whisper.cpp and Vosk local model management/transcription, recording UX, privacy, and cancellation.
...
- [../THIRD_PARTY_NOTICES.md](../THIRD_PARTY_NOTICES.md)
  - Bundled web assets, GraalJS Community, Whisper.cpp JNI, and Vosk runtime license notes.
