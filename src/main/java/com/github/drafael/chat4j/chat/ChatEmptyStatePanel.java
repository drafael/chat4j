...
final class ChatEmptyStatePanel extends JPanel {
    ...
    ChatEmptyStatePanel(List<ChatPanel.PromptQuickAction> promptQuickActions, EmptyStateActions actions) {
