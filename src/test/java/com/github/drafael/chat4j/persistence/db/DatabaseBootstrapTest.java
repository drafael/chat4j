...
class DatabaseBootstrapTest {
    ...
    void createConversation_whenSchemaIsInitialized_persistsAndLoadsConversation() throws Exception {
        ...
        assertThat(conversation).get().extracting(ConversationRepository.ConversationRecord::provider).isEqualTo("OpenAI");
        assertThat(conversation).get().extracting(ConversationRepository.ConversationRecord::model).isEqualTo("gpt-4o");
    }
